    ...
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-lg">
                        <img src="{{ asset('msg/default-logo.png') }}" alt="user-img" class="img-thumbnail rounded-circle" />
                    </div>
                </div>
                <!--end col-->
                <div class="col">
                        ...
                        <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link fs-rs-14" data-bs-toggle="tab" href="#activities" role="tab">
                                    <i class="ri-list-unordered d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Services</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-rs-14" data-bs-toggle="tab" href="#projects" role="tab">
                                    <i class="ri-price-tag-line d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Products</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-rs-14" data-bs-toggle="tab" href="#documents" role="tab">
                                    <i class="ri-folder-4-line d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Documents</span>
                                </a>
                            </li>
                        </ul>
                        <div class="flex-shrink-0">
                            <a href="{{ route('salon.edit-profile') }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                        </div>
                    </div>
                    <!-- Tab panes -->
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ (!empty($salon_details['created_at'])) ? date('d, M Y', strtotime($salon_details['created_at'])) : '#Created at' }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-4">
                                                <div class="flex-grow-1">
                                                    <h5 class="card-title mb-0">My Staffs</h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink2">
                                                            <li><a class="dropdown-item" href="#">Add New Staff</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                @foreach ($salon_staff as $single_staff)
                                                <div class="d-flex align-items-center py-3">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div>
                                                            <h5 class="fs-13 mb-1">{{ $single_staff['name'] ?: '#StaffName' }}</h5>
                                                            <p class="fs-13 text-muted mb-0">{{ $single_staff['designation'] ?: '#Staff Designation' }}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="avatar-sm">
                                                                        <div class="avatar-title bg-secondary-subtle text-white rounded fs-20">
