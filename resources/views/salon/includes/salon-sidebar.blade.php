    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li class="menu-title">Salon Menu</li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.plans_all') }}" target="_self">All Plans</a></li>
                        <li><a href="{{ route('admin.plans_add') }}" target="_self">Add New Plans</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.plans_all') }}">All Salons</a></li>
                        <li><a href="{{ route('admin.plans_add') }}">Add New Salons</a></li>
                        <li><a href="{{ route('admin.plans_add') }}">Salon Reports</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.plans_all') }}">All Settings</a></li>
                    </ul>
                </li>
